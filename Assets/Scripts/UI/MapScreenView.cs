...
namespace LighthouseMatch3.UI
{
    public sealed class MapScreenView
    {
            ...
            Action claimDailyReward)
        {
            ...
            ui.CreateText(screen.transform, translate("title", null), 48, palette.Foam, new Vector2(0.5f, 0.895f), new Vector2(520, 72), TextAnchor.MiddleCenter);
            ui.CreateText(screen.transform, translate("subtitle", null), 26, palette.Subtitle, new Vector2(0.5f, 0.842f), new Vector2(560, 48), TextAnchor.MiddleCenter);
            ...
            var resources = ui.CreateText(
                ...
                30, palette.Foam, new Vector2(0.5f, 0.825f), new Vector2(960, 58), TextAnchor.MiddleCenter);
            resources.name = "Resources";

            var daily = ui.CreateButton(
                screen.transform,
                SaveService.CanClaimDailyReward() ? translate("daily_reward", null) : translate("daily_claimed", null),
                new Vector2(.28f, .757f), new Vector2(360, 78), palette.Ocean, palette.Foam, claimDailyReward);
            ...
            ui.CreateButton(screen.transform, translate("rules", null), new Vector2(.13f, .93f), new Vector2(220, 76), palette.Ocean, palette.Foam, showRules);
            ui.CreateButton(screen.transform, translate("settings", null), new Vector2(.87f, .93f), new Vector2(220, 76), palette.Ocean, palette.Foam, showSettings);
